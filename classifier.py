...
# ═══════════════════════════════════════════════════════════════════════════
# 簇D(2026-08-20): 短多问句分析词表 —— R2d 放宽的第二道闸
# 反例防护已验证: "谁去？几点？在哪集合？"等 5 条纯事实多问句全不含这些词,
# "3问号+分析词" 组合安全。"怎么" 虽宽但反例全无, 3问号连问本身就有分析意图。
# ═══════════════════════════════════════════════════════════════════════════
_ANALYSIS_QUEST_WORDS = (
    "如何", "怎么", "选什么",
    "方案", "风险", "预算", "选型", "优化", "落地",
)


def _has_analysis_quest_word(message: str) -> bool:
    return any(w in message for w in _ANALYSIS_QUEST_WORDS)
